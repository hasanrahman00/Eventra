...
import {
  dataHubs, dataServiceLinks, engageLinks, marketingLinks, growthLinks,
    ...
    <footer className="bg-ink text-white">
      ...
      <div className="container-shell py-14">
        <div className="grid gap-10 lg:grid-cols-[1.3fr_repeat(4,1fr)]">
          ...
          <Column title="Event Data" links={dataHubs} />
          <Column title="Data Services" links={dataServiceLinks} />
        ...
        <div className="mt-12 grid gap-8 border-t border-white/10 pt-10 md:grid-cols-2 lg:grid-cols-4">
          <Column title="Engagement" links={engageLinks} />
