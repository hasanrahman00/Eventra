            ...
            {primaryNav.map((item) =>
              item.type === 'link' ? (
                <Link
                  ...
                  to={item.to}
                  onClick={onClose}
                  className="block border-b border-surface-muted py-4 text-base font-semibold text-ink"
                >
                  {item.label}
                </Link>
              ) : (
          ...
          {primaryNav.map((item) =>
            item.type === 'link' ? (
              <Link
                key={item.label}
                to={item.to}
                className="rounded-lg px-3 py-2 text-sm font-medium text-ink/80 transition hover:text-ink"
              >
                {item.label}
              </Link>
            ) : (
