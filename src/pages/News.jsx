...
const press = [
  { date: 'May 2026', tag: 'Product', title: `${brand.name} launches per-edition show mapping across all event plans`, excerpt: 'Every contact is now tagged to the specific event edition it came from, so teams can target the freshest audience for each show.' },
  { date: 'Mar 2026', tag: 'Company', title: `${brand.name} surpasses 120 million verified event contacts`, excerpt: 'A milestone driven by coverage of 40,000+ trade shows and a faster re-verification cycle.' },
  { date: 'Jan 2026', tag: 'Partnership', title: 'New native integrations with leading CRMs and sales-engagement platforms', excerpt: 'Customers can now push verified event segments directly into their stack without manual exports.' },
  { date: 'Nov 2025', tag: 'Research', title: 'The State of Event Marketing 2026 report is now available', excerpt: 'Survey of 1,200 B2B teams reveals what actually drives return on trade-show spend.' },
  { date: 'Sep 2025', tag: 'Company', title: `${brand.name} opens APAC operations in Singapore`, excerpt: 'Regional team expands localized event coverage and support across Asia-Pacific expo hubs.' },
  { date: 'Jul 2025', tag: 'Product', title: 'Pre-show campaign automation moves out of beta', excerpt: 'Automated pre-show outreach sequences are now generally available across all marketing plans.' },
]
