...
const openings = [
  { role: 'Senior Data Engineer', team: 'Data Platform', location: 'Chicago, IL / Remote', type: 'Full-time' },
  { role: 'Event Marketing Manager', team: 'Marketing', location: 'Remote (US)', type: 'Full-time' },
  { role: 'Account Executive', team: 'Sales', location: 'Chicago, IL', type: 'Full-time' },
...
export default function Careers() {
  ...
  return (
    <>
      ...
      <Section tone="subtle">
        <SectionHeading eyebrow={`Life at ${brand.name}`} title="Perks that respect your life" />
