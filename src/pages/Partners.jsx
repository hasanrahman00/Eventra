...
const partnerTypes = [
  { icon: 'Handshake', title: 'Agencies', body: 'White-label our event data and campaigns so you can deliver pipeline programs to clients.' },
  { icon: 'Boxes', title: 'Technology platforms', body: 'Embed verified event contact data into your product via flexible delivery and APIs.' },
  { icon: 'Network', title: 'Resellers', body: `Earn wholesale pricing and dedicated support reselling ${brand.name} services.` },
]
  ...
  return (
    <>
      <PageHero
        ...
        headline={`${brand.name} data, delivered into the tools you already use`}
      ...
      <Section tone="subtle">
        <SectionHeading eyebrow="Partner with us" title={`Three ways to grow with ${brand.name}`} />
        <div className="mt-12">
